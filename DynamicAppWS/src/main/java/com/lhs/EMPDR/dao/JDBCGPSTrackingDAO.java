...
public class JDBCGPSTrackingDAO {
    ...
    public String insertGPS(String seqNo, String userCode, String lat, String lng, String location,
            String locationDateTime, String deviceId, String deviceName, String para1, String para2, String para3, String para4) {
        PreparedStatement ps = null;
        System.out.println("LOCATION TRACKING");

        try {
            System.out.println("locationDateTime");
            int seq_id = 0;
            seq_id = U.nextSeqID("LHSSYS_PORTAL_APP_TRAN", c);
            String sql = "insert into LHSSYS_PORTAL_APP_LOC_TRAN (COL1,COL2,LATITUDE,LONGITUDE,LOCATION,COL7,COL8,DYNAMIC_TABLE_SEQ_ID,"
                    + "LASTUPDATE,seq_id,user_code,location_DateTime,date1,col9,col10,col11,col12)"
                    + "values('" + seqNo + "','" + userCode + "','" + lat + "','" + lng + "','" + location + "','"
                    + deviceId + "','" + deviceName + "','" + seqNo + "',sysdate," + seq_id + ",'" + userCode + "','" + locationDateTime + "',to_date('" + locationDateTime + "','dd-mm-yyyy hh24:mi:ss'),'"
...
//                    System.out.println(simple.format(result2));
                    int seq_id = 0;
                    seq_id = U.nextSeqID("LHSSYS_PORTAL_APP_TRAN", c);
                    String sql = "insert into LHSSYS_PORTAL_APP_LOC_TRAN ("
