...
public class TableDetailModel {
    ...
    String data_save_process_flag;
    String selection_clause;
    String show_type_menu_flag;
    String sqlText;
    String plSqlText;
    String view_type;
    String view_group;
    ...
    public void setTab_slno(String tab_slno) {
        this.tab_slno = tab_slno;
    }
    ...
    public void setPlSqlText(String plSqlText) {
        this.plSqlText = plSqlText;
    }
    ...
    public String getData_save_process_flag() {
        return data_save_process_flag;
    }

    public void setData_save_process_flag(String data_save_process_flag) {
        this.data_save_process_flag = data_save_process_flag;
    }
    ...
    public String getShow_type_menu_flag() {
        return show_type_menu_flag;
    }

    public void setShow_type_menu_flag(String show_type_menu_flag) {
        this.show_type_menu_flag = show_type_menu_flag;
    }
    ...
    public String getEmail_send_condition() {
        return email_send_condition;
    }

    public void setEmail_send_condition(String email_send_condition) {
        this.email_send_condition = email_send_condition;
    }
