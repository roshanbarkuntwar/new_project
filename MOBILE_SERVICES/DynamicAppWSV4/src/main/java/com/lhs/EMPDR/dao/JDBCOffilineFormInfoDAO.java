...
public class JDBCOffilineFormInfoDAO {
    ...
    public OfflineFormJSON offlineTableDetail(String entity, String appType, String userCode, String accCode, String searchText,String loginId) {
...
//            sql.append("replicate_fields,portlet_Id,List_columns_update,list_columns_order_by,update_key,DATA_UPLOAD,excel_template,first_screen,icon_image,portlet_id from lhssys_portal_table_dsc_update u where upper(module)='" + appType.toUpperCase() + "' order by seq_no");
            sql.append("select u.*,t.view_mode  from lhssys_portal_tab_mast t, lhssys_portal_table_dsc_update u where upper(u.module)='" + appType.toUpperCase() + "' and upper(t.tab_id)='" + appType + "' order by u.seq_no");
        ...
        while (itr.hasNext()) {
            ...
            try {
                ...
                addForm = record_obj.recordsDetail(entity, seqNo, userCode, accCode, searchText,"","");
