...
@NgModule({
  declarations: [FrameCanvasComponent, FrameCardComponent, FrameSummCardComponent, FrameTableComponent, frameCollapsComponent,
    ...
    FrameTermsConditionsComponent, FrameAddonComponent, SummaryCardComponent, FrameNewcalenderPipe, FramePercentageCircleComponent, AttachFileComponent, FrameEntryTableComponent,
...
TreesetComponent,FrameApexfilterComponent,FlipKpiComponent,FrameCollapseOrderEntryComponent,FramePlastoSummaryCardComponent,FocusDirective,FocusDirectiveEntryTable,FocusDirectiveCard,VideoStreamComponent,FrameGeochartComponent,FrameTravelLocationComponent,
PartitionItemComponent,FramePivotTableComponent,FrameThreeDFunnelComponent,FrameImgMiniSliderComponent
,DragDropDirective,FrameMultilevelTableComponent,TreemenuComponent,FrameReportComponent,FrameAddonComponent,MultitaskTreemenuComponent,FrameSingleScaleColumnChartComponent,
FrameNewcalenderComponent
],
  imports: [
    CommonModule,
    CalendarModule ,
    TooltipsModule.forRoot(),
    FormsModule, NgCalendarModule, 
    IonicModule, DirectivesModule, ModalPageModule, SingleSelectLovPageModule, PopoverPageModule,
    PipesModule, DragDropModule, AngularMyDatePickerModule
  ...
  exports: [FrameCanvasComponent, FrameCardComponent, FrameSummCardComponent, FrameTableComponent, frameCollapsComponent,FrameGroupTableComponent,
    ...
    FrameTermsConditionsComponent, FrameAddonComponent, SummaryCardComponent, AttachFileComponent, FrameEntryTableComponent, ApprovalTabComponent, PercentageCircleComponent,
    ...
    IonchipFilterComponent, FrameCanvasFilterComponent, FrameMapComponent, InformationCardComponent, ProgressBarComponent,
  ...
  ,ImageInputCircleComponent,ImageMenuComponent,IconMenuComponent,SimpleKpiComponent,FrameBarComponent,FrameTable2Component,
...
,FrameReportComponent,MultitaskTreemenuComponent,FrameSingleScaleColumnChartComponent,FrameImgMiniSliderComponent,
FrameNewcalenderComponent
]
