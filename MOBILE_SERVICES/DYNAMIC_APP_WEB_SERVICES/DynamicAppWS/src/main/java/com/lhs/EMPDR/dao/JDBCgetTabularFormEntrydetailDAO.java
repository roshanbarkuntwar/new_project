...
public class JDBCgetTabularFormEntrydetailDAO {
    ...
    public TabularFormEntryDetailModel getDetailOfEntry(String entity, String seq_no, String vrNo,
            String userCode, String accCode, String searchText, String sqlFlag) throws SQLException {
...
//        sql.append("select u.*,column_name,column_desc,column_type from lhssys_portal_data_dsc_update u where ");
//        sql.append("seq_no=" + seq_no);
//        try {
//
//            ps = connection.prepareStatement(sql.toString());
//
...
//        }
        try {
            ...
            try {
                json = dao.recordsDetail(entity, seq_no, userCode, accCode, searchText, sqlFlag);
