...
export class UserauthenticationService {
  ...
  selectAppkey(app) {
    if (app && !this.isProcessing) {
      ...
      if(app.resData.serverUrl && app.resData.serverUrl.indexOf('http') > -1){
        server_url = app.resData.serverUrl + "/" + app.resData.war_name + "/" + app.resData.entity + "/" + app.resData.dbUrl + "/" + app.resData.portNo + "/" + app.resData.dbName + "/" + encodeURIComponent(app.resData.dbPassword) + "/" + app.resData.dbSid + "/";
      }else{
        server_url = "http://" + app.resData.serverUrl + "/" + app.resData.war_name + "/" + app.resData.entity + "/" + app.resData.dbUrl + "/" + app.resData.portNo + "/" + app.resData.dbName + "/" + encodeURIComponent(app.resData.dbPassword) + "/" + app.resData.dbSid + "/";
      }
      
      if(app.resData.server_url2 && app.resData.server_url2.indexOf('http') > -1){
        server_url2 =  app.resData.server_url2 + "/" + app.resData.war_name + "/" + app.resData.entity + "/" + app.resData.dbUrl + "/" + app.resData.portNo + "/" + app.resData.dbName + "/" + encodeURIComponent(app.resData.dbPassword) + "/" + app.resData.dbSid + "/";
      }else{
        server_url2 = "http://" + app.resData.server_url2 + "/" + app.resData.war_name + "/" + app.resData.entity + "/" + app.resData.dbUrl + "/" + app.resData.portNo + "/" + app.resData.dbName + "/" + encodeURIComponent(app.resData.dbPassword) + "/" + app.resData.dbSid + "/";
      }
      if(app.resData.server_url3 && app.resData.server_url3.indexOf('http') > -1){
        server_url3 = app.resData.server_url3 + "/" + app.resData.war_name + "/" + app.resData.entity + "/" + app.resData.dbUrl + "/" + app.resData.portNo + "/" + app.resData.dbName + "/" + encodeURIComponent(app.resData.dbPassword) + "/" + app.resData.dbSid + "/";
      }else{
        server_url3 = "http://" + app.resData.server_url3 + "/" + app.resData.war_name + "/" + app.resData.entity + "/" + app.resData.dbUrl + "/" + app.resData.portNo + "/" + app.resData.dbName + "/" + encodeURIComponent(app.resData.dbPassword) + "/" + app.resData.dbSid + "/";
      }
      if(app.resData.server_url4 && app.resData.server_url4.indexOf('http') > -1){
        server_url4 = app.resData.server_url4 + "/" + app.resData.war_name + "/" + app.resData.entity + "/" + app.resData.dbUrl + "/" + app.resData.portNo + "/" + app.resData.dbName + "/" + encodeURIComponent(app.resData.dbPassword) + "/" + app.resData.dbSid + "/";
      }else{
        server_url4 = "http://" + app.resData.server_url4 + "/" + app.resData.war_name + "/" + app.resData.entity + "/" + app.resData.dbUrl + "/" + app.resData.portNo + "/" + app.resData.dbName + "/" + encodeURIComponent(app.resData.dbPassword) + "/" + app.resData.dbSid + "/";
      }
      ...
      if (parseInt(pcnt) > 0) {
        ...
        setTimeout(() => {
          this.getAppHeaderData().then(() => {
            ...
            if(this.globalObjects.switchapp){
              this.events.publish("refresh_app");
              this.globalObjects.switchapp = false;
            }
          })
        }, 1000);
      }
  ...
  async popoveruser() {
    let flag = this.globalObjects.switchapp;
