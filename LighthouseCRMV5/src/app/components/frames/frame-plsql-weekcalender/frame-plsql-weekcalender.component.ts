...
@Component({
  selector: 'app-frame-plsql-weekcalender',
  templateUrl: './frame-plsql-weekcalender.component.html',
  styleUrls: ['./frame-plsql-weekcalender.component.scss'],
})
export class FramePlsqlWeekcalenderComponent implements OnInit {
