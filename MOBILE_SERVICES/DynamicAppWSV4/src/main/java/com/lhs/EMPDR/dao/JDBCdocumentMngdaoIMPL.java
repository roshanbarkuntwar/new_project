...
public class JDBCdocumentMngdaoIMPL implements JDBCdocumentMngdao {
    ...
    String status = "IMAGE NOT INSERTED 0";
    ...
    public String manageDoc(String jsonString) {
        ...
        try {
            ...
            String doc_ref = (String) jsobj.get("DOC_REF");
            ...
            try {
                ...
                if (rs != null && rs.next()) {
                    do {
                        ...
                        System.out.println("DOC_CODE : " + docCode);
                ...
                if (obj1.get("file") != null && obj1.get("file").toString().length() > 3) {
                    ...
                    try {
                        ...
                        if (ii > 0) {
                            ...
                            status = "IMAGE NOT INSERTED 1";
                        }
                        U.log("IMAGE INSERT STATUS : " + status);
                    } catch (Exception e) {
                        U.errorLog(e);
                        status = "IMAGE NOT INSERTED 2";
                    } finally {
                        if (ps != null) {
                            try {
                                ps.close();
                            } catch (SQLException ex) {
                                status = "IMAGE NOT INSERTED 3";
                            }
                        }
                    }
    ...
    public String insertDocument(String fileName, String userCode, String desc,
        ...
        try {
            ...
            if (i > 0) {
                ...
                status = "IMAGE NOT INSERTED 5";
            }
//            U.log("IMAGE INSERT STATUS : " + status);
        } catch (Exception e) {
            e.printStackTrace();
            status = "IMAGE NOT INSERTED 6";
            U.errorLog(e);
        } finally {
            if (pst != null) {
                try {
