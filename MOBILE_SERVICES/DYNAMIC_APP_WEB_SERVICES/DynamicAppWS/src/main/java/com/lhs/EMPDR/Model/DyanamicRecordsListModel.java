 ...
 */
public class DyanamicRecordsListModel {
    ...
    String nextPageFirstScreen;
    String nextPageSeqNo;
    String nextPageButtonName;
...
//            dao.getLovDyanamically(seqNo, column_name, null);
    ...
    public String getNextPageFirstScreen() {
        return nextPageFirstScreen;
    }

    public void setNextPageFirstScreen(String nextPageFirstScreen) {
        this.nextPageFirstScreen = nextPageFirstScreen;
    }

    public String getNextPageSeqNo() {
        return nextPageSeqNo;
    }

    public void setNextPageSeqNo(String nextPageSeqNo) {
        this.nextPageSeqNo = nextPageSeqNo;
    }
