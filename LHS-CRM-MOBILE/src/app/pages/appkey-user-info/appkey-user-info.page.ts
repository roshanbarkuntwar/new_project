import { NavParams, NavController, ModalController, Events,Platform } from '@ionic/angular';
...
export class AppkeyUserInfoPage implements OnInit {
  ...
  loginBypass(rowData, responseData){
    ...
    + "&latitude=" + encodeURIComponent(this.globalObjects.latitude) + "&longitude=" + encodeURIComponent(this.globalObjects.longitude) + "&platform=" + encodeURIComponent(this.globalObjects.platformVal)
